...
const Configuration = () => {
    ...
    const searchEmployers = useSelector(
        (state) => state.employer.searchEmployers
    );
    ...
    const searchValueEmployer = useSelector(
        (state) => state.employer.searchValueEmployer
    );
    ...
    const currentRecordsEmp = employers.slice(
        indexOfFirstRecordEmp,
        indexOfLastRecordEmp
    );
    const currentRecordsJob = jobs.slice(
        indexOfFirstRecordJob,
        indexOfLastRecordJob
    );
            ...
            <Container fluid style={{ marginTop: 25, paddingBottom: 30 }}>
                ...
                <Row>
                        ...
                        <Row>
                            ...
                            >
                                ...
                                <Input
                                    ...
                                    onChange={(e) => {
                                        dispatch(
                                            employerActions.searchEmployer(
                                                e.target.value
                                            )
                                        );
                                        if (e.target.value === "") {
                    ...
                    <Col xs={12} sm={6} md={6} lg={6}>
                        <Row style={{ marginBottom: 10 }}>
                            <Col>
                                <h3 style={{ textAlign: "center" }}>Travail</h3>
                            </Col>
                        </Row>
                        <Row>
                            <Col
                            ...
                            >
                                ...
                                <Input
                                    ...
                                    onChange={(e) => {
                                        dispatch(
                                            jobActions.searchJob(e.target.value)
                                        );
                                        if (e.target.value === "") {
                                            dispatch(
                                                jobActions.clearSearchJob()
