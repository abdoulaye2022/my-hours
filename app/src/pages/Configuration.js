                ...
                <Row>
                    <Col xs={12} sm={6} md={6} lg={6}>
                        <Row style={{ marginBottom: 10 }}>
                            <Col>
                                <h3 style={{ textAlign: "center" }}>Employeur</h3>
                            </Col>
                        </Row>
                        <Row>
                            <Col style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
                                <div>
                                    ...
                                    <EmployerModal employer={employer} setEmployer={setEmployer} />
                                </div>
                                    ...
                                    <Table.Body>
                                        {employers.map((p, i) => (
                                            p.statut === 1 ?
                                                ...
                                                : <Popup
                                                    trigger={
                                                        <Table.Row negative className="rowedit">
                                                            <Table.Cell>{p.name_emp}</Table.Cell>
                                                            <Table.Cell>
                                                                <Icon name='cancel' />
                                                                Inactif
                    ...
                    <Col xs={12} sm={6} md={6} lg={6}>
                        ...
                        <Row>
                            <Col style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
                                <div>
                                    <Button attached='left' primary onClick={() => dispatch(jobActions.modalJob())}><Icon name='add' />Ajouter</Button>
                            ...
                            <Col>
                                <Table celled striped selectable={true} singleLine={true} size="small">
                                    <Table.Header>
                                        <Table.Row>
                                            <Table.HeaderCell>Nom</Table.HeaderCell>
                                            <Table.HeaderCell>Employeur</Table.HeaderCell>
                                                ...
                                                <Popup
                                                    trigger={
                                                        <Table.Row positive className="rowedit">
                                                            ...
                                                            <Table.Cell>{p.name_emp}</Table.Cell>
                                                            <Table.Cell>
                                                                <div style={{ width: "50%", height: 20, backgroundColor: p.color_job }}></div>
                                                            </Table.Cell>
                                                        </Table.Row>
                                                    }
                                                    content={
